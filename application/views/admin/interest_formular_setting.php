	...
	<div class="kt-portlet__head kt-portlet__head--lg">
		...
		<div class="kt-portlet">
			<!--begin::Form-->
				...
				<?php echo form_open("admin/create_interest_formular",['class'=>'kt-form']) ?>
					...
					<div class="form-group form-group-marginless">
						<div class="row">
							...
							<div class="col-lg-4">
								...
								<input type="checkbox" name="formular_name[]" value="SIMPLE">
								<span></span>
								...
								<span class="kt-option__control">
								<span class="kt-radio kt-radio--check-bold">
								<input type="checkbox" name="formular_name[]" value="FLAT RATE">
								<span></span>
								...
								<span class="kt-option__control">
								<span class="kt-radio kt-radio--check-bold">
								<input type="checkbox" name="formular_name[]" value="REDUCING">
								<span></span>
								</span>
								</span>
								<span class="kt-option__label">
						...
						<div class="row">
							...
							<div class="col-lg-4">
							   ...
							   <?php }elseif($datas->formular_name == 'FLAT RATE'){ ?>
								...
								<a href="<?php echo base_url("admin/delete_formular/{$datas->id}") ?>" style="color:red;" onclick="return confirm('Are you sure?')">Remove</a>				
								</span>										
								</span>
								</span>		
								</label> 
