                ...
                <div class="kt-widget__content">
                    <div class="kt-widget__head">
                        <a href="#" class="kt-widget__username">
                            <b class="a"> <?php echo $customer_profiles->f_name ?> <?php echo $customer_profiles->m_name ?> <?php echo $customer_profiles->l_name ?> / <?php echo $customer_profiles->code; ?></b>   
                            <i class=""></i>                       
                        </a>
                        ...
                        <div class="kt-widget__action">
                         <div class="">
                         	<?php if ($customer_profiles->signature == TRUE) {
                         	 ?>
                    <img src="<?php echo base_url().'assets/img/'.$customer_profiles->signature; ?>" alt="Signature"style="width: 200px; height: 180px;">
                <?php }else{ ?>
					...
					<div class="kt-section">
						...
						<input type="text" name="l_name"  autocomplete="off" readonly value="<?php echo $customer_profiles->region_name; ?>" class="form-control input-sm" >
							...
							<input type="text" name="l_name" placeholder="Last name" autocomplete="off" readonly value="<?php echo $customer_profiles->street; ?>" class="form-control input-sm" required>
										...
										<div class="col-lg-3 form-group-sub">
									<label class="form-control-label"><b>Nick Name</b></label>
					...
					<div class="kt-section">
						...
						<?php } ?></textarea>
								...
								<div class="col-lg-12">
									<div class="text-center">
									<br><br>
									<h4>LOCAL GOVERNMENT / EMPLOYER INFORMATION</h4>
									</div>
								</div>
									<div class="col-lg-3 form-group-sub">
							...
							<input type="number" name="" placeholder="Officer Phone Number" autocomplete="off" value="<?php echo @$local_oficer->phone_oficer; ?>" class="form-control input-sm" readonly>
									...
									<div class="col-lg-3 form-group-sub">
									<label class="form-control-label"><b>Officer Position</b></label>
							<input type="text" name="" placeholder="Officer Position" autocomplete="off" value="<?php echo @$local_oficer->oficer_position; ?>" class="form-control input-sm" readonly>
								</div>
									<div class="col-lg-3 form-group-sub">
									<label class="form-control-label"><b>Region</b></label>
							...
							<input type="text" name="" placeholder="Ward" autocomplete="off" class="form-control input-sm" value="<?php echo @$local_oficer->ward_oficer; ?>" readonly>
							   ...
							   <a href="<?php echo base_url().'admin/download_attach/'.@$local_oficer->attach_id; ?>" class="btn btn-brand"><i class="flaticon-download"></i>View Loan Agreement</a>
							<?php }elseif(@$local_oficer->cont_attachment == FALSE){ ?>
                            <a href="javascript:;" class="btn btn-danger"><i class="flaticon-download"></i>No Loan Agreement </a>
								<?php } ?>
								</div>
