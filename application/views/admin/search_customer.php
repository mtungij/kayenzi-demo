                        ...
                        <div class="kt-section__content">
                            <div class="form-group form-group-last row">
                                <div class="col-lg-4 form-group-sub">
                                    ...
                                    <input type="text" name="sp_name" placeholder="" autocomplete="off" value="<?php echo $sponsers_datas->sp_name; ?>" class="form-control input-sm">
                                </div>
                                <div class="col-lg-4 form-group-sub">
                                    <label class="form-control-label">*Middle Name:</label>
                                    <input type="text" name="sp_mname" placeholder="Amount" autocomplete="off" value="<?php echo $sponsers_datas->sp_mname; ?>" class="form-control input-sm">
                                </div>
                                
                             <div class="col-lg-4 form-group-sub">
                                    <label class="form-control-label">*Last Name:</label>
                                    <input type="text" name="sp_lname" placeholder="Amount" autocomplete="off" value="<?php echo $sponsers_datas->sp_lname; ?>" class="form-control input-sm">
                                </div>

                              <div class="col-lg-4 form-group-sub">
                                    <label class="form-control-label">*Phone Number:</label>
                                    <input type="number" name="sp_phone_no" placeholder="Amount" autocomplete="off" value="<?php echo $sponsers_datas->sp_phone_no; ?>" class="form-control input-sm">
                                </div>
                                 <div class="col-lg-4 form-group-sub">
                                    <label class="form-control-label">*Natinal ID/Vote ID/Driver Lisence:</label>
                                    <input type="number" name="sp_nation" placeholder="Natinal ID/Vote ID/Driver Lisence" autocomplete="off" value="<?php echo $sponsers_datas->sp_nation; ?>" class="form-control input-sm">
                                </div>
                                <div class="col-lg-4 form-group-sub">
...
<?php }else{ ?>
 ...
 <div class="col-lg-12">
  ...
  <!-- <form class="form-horizontal" action="<?php //site_url()?>create_sponser/{$customer->customer_code}" method="post"> -->
    <?php echo form_open("admin/create_sponser/{$customer->customer_id}/{$customer->comp_id}",['class'=>'form-horizontal']) ?>
    ...
    <div class="form-group">
      <label>Region:</label>  
        <select type="text" name="sp_region[]" id="nature" class="form-control">
...
OOPS!  There no customer with that number</h1>
      <a href="<?php echo base_url("admin/loan_application"); ?>" class="btn btn-info">Back</a>
    </div>
