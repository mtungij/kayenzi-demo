	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open("admin/create_group",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
						...
						<div class="kt-section__content">
							<div class="form-group form-group-last row">
								<div class="col-lg-6 form-group-sub">
									...
									<select type="text" name="blanch_id" class="form-control select2" required>
								...
								<div class="col-lg-6 form-group-sub">
									...
									<input type="text" name="group_name" autocomplete="off" placeholder="Group name" class="form-control" required>
								</div>
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<ul class="kt-nav">
					...
					<li class="kt-nav__item">
						<a href="<?php echo base_url("admin/delete_group/{$groups->group_id}") ?>" class="kt-nav__link" onclick="return confirm('Are you sure?')">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open("admin/modify_group/{$groups->group_id}"); ?>
