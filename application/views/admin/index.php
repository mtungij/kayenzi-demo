				...
				<div class="kt-invoice__head" style="background-image: url('<?php echo base_url() ?>assets/img/pi.png');">
					<div class="kt-invoice__container kt-invoice__container--centered">
						<div class="kt-invoice__logo">
							<a href="#">
								<!-- <h1><?php //echo number_format(($receive_Amount->total_receve_amaount + $loan_depost->Total_depost + $loan_fee->sum_withdraw) - ($request_expences->total_exp)); ?> - Account balance</h1> -->

									 <h1><?php echo number_format($sum_comp_capital->total_comp_balance); ?> - Account balance</h1> 

								<?php //echo number_format($loanAprove->total_loanAprove  + $loan_depost->Total_depost + $receive_Amount->total_receve_amaount + $loan_fee->sum_withdraw - $request_expences->total_exp - $withdrawal->withdrawal_amount); ?></h1>
							</a>
						</div>
						<div class="kt-invoice__items">
							...
							<div class="kt-invoice__item">
								<span class="kt-invoice__subtitle"><b>Total Branch Accounts.</b></span>
								<span class="kt-invoice__text"><b><?php echo number_format($blanch_capital_circle->total_balanch_amount); ?></b></span>
							</div>
							...
							<div class="kt-invoice__item">
								...
								<span class="kt-invoice__text"><b><?php echo number_format($total_non->total_nondeducted + $total_deducted_balance->total_deducted)?></b></span>
							</div>
							<div class="kt-invoice__item">
								<span class="kt-invoice__subtitle"><b>Total Expenses</b></span>
								<span class="kt-invoice__text"><b><?php echo number_format($request_expences->total_exp); ?></b></span>
							</div>
						<div class="kt-invoice__item">
           ...
           <!--                <div class="kt-widget17__items">
             ...
             <div class="kt-widget17__items">
						...
						<img src="<?php echo base_url() ?>assets/img/penart.png" style="width: 50px;height: 50px;">
							<b>Today Loan pending(<?php echo $laza->num_rows(); ?>)</b><!--  / <b style="color:green;">(<?php echo number_format( $today_total_loan_pend->total_pend); ?>)</b> -->
						</span> </a> 
						</div>
						...
						<?php 
						$today = date("Y-m-d");
							$exp_req = $this->db->query("SELECT * FROM tbl_request_exp WHERE comp_id = '$comp_id' AND req_date = '$today'");

							 ?>
						<a href="<?php echo base_url("admin/get_recomended_request"); ?>"><span class="kt-widget17__subtitle">
