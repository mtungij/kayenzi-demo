...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__head-actions">
		...
		&nbsp;
		<a href="<?php echo base_url("admin/block_allEmployee"); ?>" class="btn btn-danger btn-elevate btn-icon-sm">
			<i class="la flaticon-delete"></i>
			Block All
		</a>

		<a href="<?php echo base_url("admin/unblock_allEmployee"); ?>" class="btn btn-success btn-elevate btn-icon-sm">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<ul class="kt-nav">
					...
					<li class="kt-nav__item">
						<a href="<?php echo base_url("admin/privillage/{$employees->empl_id}"); ?>" class="kt-nav__link">
						<i class="kt-nav__link-icon flaticon-eye" ></i>
					...
					<?php if ($employees->empl_status == 'open') {
					 ?>
			 	<li class="kt-nav__item">
						<a href="<?php echo base_url("admin/block_employee/{$employees->empl_id}") ?>" class="kt-nav__link" onclick="return confirm('Are you sure?')">
				...
				<?php }elseif($employees->empl_status == 'close'){ ?>
					<li class="kt-nav__item">
						<a href="<?php echo base_url("admin/Unblock_employee/{$employees->empl_id}") ?>" class="kt-nav__link" onclick="return confirm('Are you sure?')">
					...
					<?php }  ?>
					<li class="kt-nav__item">
						<a href="<?php echo base_url("admin/delete_employee/{$employees->empl_id}") ?>" class="kt-nav__link" onclick="return confirm('Are you sure?')">
    ...
    <div class="modal-dialog modal-lg" role="document">
		...
		<div class="kt-portlet">
			<!--begin::Form-->
				...
				<?php echo form_open("admin/create_Employee_privillage/{$employees->empl_id}",['class'=>'kt-form']) ?>
				<div class="kt-portlet__body">
