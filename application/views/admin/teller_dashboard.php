							...
							<div class="kt-section__content">
								<div class="form-group form-group-last row">
									...
									<div class="col-lg-8 form-group-sub">
										...
										<select class="form-control kt-selectpicker uppercase-text" name="customer_id"
											required data-live-search="true">
											<option value="">Select customer</option>
											<?php foreach ($customer as $customers): ?>
												<option value="<?php echo $customers->customer_id; ?>">
													<?php echo strtoupper($customers->f_name . ' ' . $customers->m_name . ' ' . $customers->l_name . ' / ' . $customers->blanch_name); ?>
												</option>
											<?php endforeach; ?>
										</select>
									</div>
