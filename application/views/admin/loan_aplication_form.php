	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open("admin/create_loanapplication/{$customer->customer_id}",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
					...
					<div class="kt-section">
						<div class="kt-section__content">
							<div class="form-group form-group-last row">
									...
									<select type="number" name="day" class="form-control select2 input-sm" required class="form-control input-sm">
								...
								<input type="number" name="session" placeholder="Enter Number of Repayments" autocomplete="off" class="form-control input-sm" required>
									  ...
									  <div class="col-lg-3 form-group-sub">
										...
										<select type="number" name="rate" class="form-control select2" required>
											<option value="">Select interest Formular</option>
											<?php foreach ($formular as $formulars): ?>	
											<option value="<?php echo $formulars->formular_name; ?>">
												<?php if ($formulars->formular_name == 'SIMPLE') {
												 ?>
												 SIMPLE FORMULAR
												<?php }elseif($formulars->formular_name == 'FLAT RATE'){ ?>
                                                 FLAT RATE FORMULAR
...
<?php }elseif($loan_option->loan_status == 'open'){ ?>
	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!--begin::Form-->
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open("admin/modify_loanapplication/{$customer->customer_id}/{$skip_next->loan_id}",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
				<div class="kt-portlet__body">
					<div class="kt-section">
						<div class="kt-section__content">
							<div class="form-group form-group-last row">
					...
					<div class="kt-form__actions">
						<div class="row">
							<div class="col-lg-12">
								...
								<a href="<?php echo base_url("admin/collelateral_session/{$skip_next->loan_id}") ?>" class="btn btn-info btn-elevate btn-pill btn-sm">Skip</a>
								</div>
							</div>
						</div>
					</div>
	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!--begin::Form-->
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open("admin/modify_loanapplication/{$customer->customer_id}/{$reject_skip->loan_id}",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
				<div class="kt-portlet__body">
					<div class="kt-section">
						<div class="kt-section__content">
							<div class="form-group form-group-last row">
									...
									<option value="<?php echo $reject_skip->day; ?>">
										...
										<?php }elseif($reject_skip->day == '7'){
											 echo "Weekly";
										 ?>
										 <?php }elseif($reject_skip->day == '30' || $reject_skip->day == '31' || $reject_skip->day == '29' || $reject_skip->day == '28'){
										 	echo "Monthly";
										  ?>
											<?php } ?>
										</option>
