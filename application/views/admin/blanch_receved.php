...
<div class="kt-portlet kt-portlet--mobile">
	...
	<a href="" class="btn btn-info" class="kt-nav__link" data-toggle="modal" data-target="#kt_modal_4"><i class="kt-menu__link-icon flaticon2-search-1"></i>Filter</a>
		<a href="<?php echo base_url("admin/today_receved_loan"); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
			<i class="flaticon2-back-1"></i>
			Back
		</a>
		<?php if (count($data_blanch) > 0) {
		 ?>
		<a href="<?php echo base_url("admin/print_received_deposit/{$from}/{$to}/{$blanch_id}/{$empl_id}/{$dep_status}") ?>" target="_blank" class="btn btn-primary">print</a>
	<?php }else{ ?>
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                    ...
                    <tr>
                                       <th><b>TOTAL</b></th>
										...
										<th><b></b></th>
										<th><b></b></th>
										<th><b><?php echo number_format($total_receve_blanch->toal_deposit); ?></b></th>
