	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open("admin/create_account_transaction",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
						...
						<div class="kt-section__content">
							<div class="form-group form-group-last row">
								...
								<div class="col-lg-8 form-group-sub">
									...
									<input type="text" placeholder="eg,NMB" class="form-control" name="account_name" required autocomplete="off">
								</div>
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<ul class="kt-nav">
					...
					<li class="kt-nav__item">
						<a href="<?php echo base_url("admin/Delete_account/{$accounts->trans_id}") ?>" class="kt-nav__link" onclick="return confirm('Are you sure?')">
