...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__body">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
								    ...
								    <tbody>
                                          <?php $no = 1; ?>
									<?php foreach ($new_pending as $loan_pends): ?>
									          <tr>
				  					<td><?php echo $no++; ?>.</td>
				  					...
				  					<td>
				  						...
				  						<?php }elseif ($loan_pends->day == '7'){
				  							echo "Weekly";
				  						 ?>
				  						 <?php }elseif ($loan_pends->day == '30' || $loan_pends->day == '31' || $loan_pends->day == '28' || $loan_pends->day == '29') {
				  						 	echo "Monthly";
				  						  ?>
				  						  <?php } ?>
					...
					<th></th>
					<th></th>
					<th><?php echo number_format($total_pending_new->total_pending); ?></th>
					<th></th>
				<!-- 	<th></th> -->
                    </tr>
                   </tfoot>
