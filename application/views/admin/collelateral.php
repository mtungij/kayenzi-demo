...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
 ...
 <div class="col-lg-12">
    ...
    <?php echo form_open("admin/create_colateral/{$loan_attach->loan_id}",['class'=>'form-horizontal']) ?>
    ...
    <a href="<?php echo base_url("admin/local_government/{$loan_attach->loan_id}"); ?>" class="btn btn-brand">Next</a>
    </div>
     </div>
  <?php echo form_close(); ?>
</div>
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <ul class="kt-nav">
                    ...
                    <li class="kt-nav__item">
                        <a href="<?php echo base_url("admin/delete_colateral/{$collaterals->loan_id}/{$collaterals->col_id}") ?>" class="kt-nav__link" onclick="return confirm('Are you sure?')">
