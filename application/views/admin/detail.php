	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open_multipart("admin/create_lastDetail/{$customer->customer_id}",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
				<div class="kt-portlet__body">
					<div class="kt-section">
						<div class="kt-section__content">
							...
							<select type="text" name="martial_status" class="form-control select2 input-sm" required>
							...
							<select type="number" name="account_id" class="form-control select2 input-sm" data-required="true">
								<option value="">Select</option>
