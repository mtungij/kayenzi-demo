	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open("admin/search_customer",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
					...
					<div class="kt-section">
						<div class="kt-section__content">
							...
							<select class="form-control kt-selectpicker" name="customer_id" required data-live-search="true">
								...
								<option value="<?php echo $customers->customer_id; ?>"><?php echo $customers->f_name; ?> <?php echo $customers->m_name; ?> <?php echo $customers->l_name; ?> / <?php echo $customers->customer_code; ?> / <?php echo $customers->blanch_name; ?> </option>
									<?php endforeach; ?>
								</select>
							</div>
