				 ...
				 <?php echo substr($loan_aproveds->loan_day, 0,10); ?>
				                        ...
				                        <td>
				                        	<?php if ($loan_aproveds->fee_status == 'YES') {
				                        	 ?>
				                        	<a href="<?php echo base_url("oficer/disburse/{$loan_aproveds->loan_id}") ?>" class="btn btn-info"><i class="kt-menu__link-icon flaticon2-shield"></i>Disburse</a>
				                        <?php }elseif($loan_aproveds->fee_status == 'NO'){ ?>
				                        	<a href="<?php echo base_url("oficer/disburse_lonnottfee/{$loan_aproveds->loan_id}") ?>" class="btn btn-info"><i class="kt-menu__link-icon flaticon2-shield"></i>Disburse</a>
				                        	
				                        	<?php } ?>
				                        </td>
				                        <?php }elseif($manager->position_id == '21'){?>
				                        	  <td>
				                        	<?php if ($loan_aproveds->fee_status == 'YES') {
				                        	 ?>
				                        	<a href="<?php echo base_url("oficer/disburse/{$loan_aproveds->loan_id}") ?>" class="btn btn-info"><i class="kt-menu__link-icon flaticon2-shield"></i>Disburse</a>
