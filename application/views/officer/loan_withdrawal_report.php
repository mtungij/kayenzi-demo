...
<p style="font-size:12px;text-align:center;" class="c"><?php echo $blanch->blanch_name; ?> - LOAN WITHDRAWAL REPORT <?php //echo $day; ?></p>
...
<table>
 ...
 <tr>
    ...
    <td style="font-size:12px;border: none;" class="c"><b><?php echo number_format($total_interest_loan->total_loan_int); ?></b></td>
