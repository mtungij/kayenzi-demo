					...
					<div class="kt-section">
						<div class="kt-section__content">
							<div class="form-group form-group-last row">
								    ...
								    <input type="text" name="" placeholder="Loan Amount Applied" autocomplete="off" value="<?php echo $loan_form->loan_name; ?> <?php echo $loan_form->loan_price; ?>" readonly class="form-control input-sm">
									</div>
						...
						<?php } ?></textarea>
							...
							<input type="text" name="" placeholder="Ward" autocomplete="off" class="form-control input-sm" value="<?php echo @$local_oficer->ward_oficer; ?>" readonly>
								...
								<div class="col-lg-3 form-group-sub">
									<br>
							   <a href="<?php echo base_url().'oficer/download_attach/'.@$local_oficer->attach_id; ?>" class="btn btn-brand"><i class="flaticon-download"></i>View Loan Agreement</a>
								</div>
					...
					<div class="kt-form__actions">
						<div class="row">
							<div class="col-lg-12">
								...
								<a href="<?php echo base_url("oficer/reject_loan/{$loan_form->loan_id}") ?>" class="btn btn-danger  btn-elevate btn-pill btn-sm">Reject</a>
								<a href="<?php echo base_url("oficer/loan_pending") ?>" class="btn btn-info  btn-elevate btn-pill btn-sm">Back</a>
								</div>
							</div>
						</div>
					</div>
